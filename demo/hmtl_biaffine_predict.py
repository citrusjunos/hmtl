...
class HMTLPredictor:
    ...
    def inference_parser(self, batch):
        ...
        if pos_tags is not None and sub_model._pos_tag_embedding is not None:
            embedded_pos_tags = sub_model._pos_tag_embedding(pos_tags)
...
if __name__ == "__main__":
    ...
    hmtl = HMTLPredictor(model_path=args.model_path)
