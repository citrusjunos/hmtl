...
class HMTLPredictor:
    ...
    def inference(self, batch, required_tasks):
        ...
        decoding_dict_ner = self.decode(task_output=output_ner, task_name="vmwer")
        final_output["vmwer"] = decoding_dict_ner["tags"]
    ...
    def decode(self, task_output, task_name: str = "vmwer"):
        """
