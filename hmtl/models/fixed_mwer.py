...
@Model.register("fixed_mwer")
class Fixed_mwer(Model):
    def __init__(self, vocab: Vocabulary, params: Params, regularizer: RegularizerApplicator = None):

        super(Fixed_mwer, self).__init__(vocab=vocab, regularizer=regularizer)
        ...
        logger.info("Fixed-MWER Model has been instantiated.")
