...
from hmtl.modules.text_field_embedders import ShortcutConnectTextFieldEmbedderCustom
...
@Model.register("hmtl_tandem_with_connection_from_mlp_of_parser_to_vmwe_encoder")
class HMTL_tandem_with_connection_from_mlp_of_parser_to_vmwe_encoder(Model):
    def __init__(self, vocab: Vocabulary, params: Params, regularizer: RegularizerApplicator = None):

        super(HMTL_tandem_with_connection_from_mlp_of_parser_to_vmwe_encoder, self).__init__(vocab=vocab, regularizer=regularizer)
        ...
        tagger_dep_parsing = BiaffineDependencyParserCustom(
            vocab=vocab,
        ...
        shortcut_text_field_embedder_vmwer = ShortcutConnectTextFieldEmbedderCustom(
           base_text_field_embedder = self._text_field_embedder,
            previous_encoders = [self._encoder_ner, self._encoder_dep_parsing],
            additional_encoder = self._tagger_dep_parsing
        )
