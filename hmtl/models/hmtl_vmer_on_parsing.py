...
@Model.register("hmtl_vmer_on_parsing")
class HMTL_vmer_on_parsing(Model):
    def __init__(self, vocab: Vocabulary, params: Params, regularizer: RegularizerApplicator = None):

        super(HMTL_vmer_on_parsing, self).__init__(vocab=vocab, regularizer=regularizer)
        ...
        #   base_text_field_embedder=self._text_field_embedder, previous_encoders=[]
        #)
        ...
        shortcut_text_field_embedder_vmwer = ShortcutConnectTextFieldEmbedder(
           base_text_field_embedder=self._text_field_embedder, previous_encoders=[self._encoder_dep_parsing]
        )
