...
@Model.register("biaffine_parser_custom")
class BiaffineDependencyParserCustom(Model):
    """
    ...
    def __init__(self,
        ...
        super(BiaffineDependencyParserCustom, self).__init__(vocab, regularizer)
    ...
    def get_mlp_outputs(self, words: Dict[str, torch.LongTensor]):
        ...
        return [head_arc_representation, child_arc_representation, head_tag_representation, child_tag_representation]
